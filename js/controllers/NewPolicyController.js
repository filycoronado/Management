app.controller('NewPolicyController', ['$rootScope', '$scope', '$filter', '$routeParams', '$http', '$timeout', function ($rootScope, $scope, $filter, $routeParams, $http, $timeout) {
        ...
        $scope.save_policy = function () {
            ...
            $http.post('./Backend/web/index.php?r=api/save_policy', {id: id, policy: $scope.policy, dealer: $scope.dealership, payment: $scope.payment}).then(function success(response) {
